...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses '<CloseApps>' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
	...
	Start-ADTProcess -FilePath "<InstallationPath>" -ArgumentList "<InstallationParameter>"
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses '<CloseApps>' -CloseProcessesCountdown 60
	...
	Start-ADTProcess -FilePath "<UninstallationPath>" -ArgumentList "<UninstallationParameter>"
